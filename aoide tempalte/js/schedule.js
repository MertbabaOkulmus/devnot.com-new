    ...
    const scheduleData = [
        {
            salon: "Salon 1",
            events: [
                { time: "15:00 pm - 17:00 pm", speaker: "Taylan Güney", image: "img/speakers/taylan-guney.jpg", title: "Keynote" },
                { time: "18:00 pm - 19:00 pm", speaker: "Ahmet Yılmaz", image: "img/speakers/olcay-atlioglu.jpg", title: "Frontend Trends" }
            ]
        },
        {
            salon: "Salon 2",
            events: [
                { time: "15:00 pm - 16:30 pm", speaker: "Elif Kaya", image: "img/speakers/merve-ucarkosar.jpg", title: "Vue.js Workshop" },
                { time: "17:00 pm - 18:00 pm", speaker: "Burak Demir", image: "img/speakers/lemi-orhan-ergin.jpg", title: "React Best Practices" }
            ]
        }
    ];
    ...
    scheduleData.forEach((salon) => {
        ...
        salon.events.forEach((event) => {
            ...
            eventElement.innerHTML = `
                ...
                <div class="col-md-9 mt-4 mt-md-0" style="display: flex; align-items: center;">
